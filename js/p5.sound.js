/** [p5.sound]  Version: 1.0.0 - 2021-03-04 */ ! function (n) {
  var i = {};
  ...
  var w, x = p.audiocontext;
  void 0 !== x.createStereoPanner ? w = function () {
    function n(t, e) {
      g(this, n), this.stereoPanner = this.input = x.createStereoPanner(), t.connect(this.stereoPanner), this.stereoPanner.connect(e)
    }
    return T(n, [{
      key: "pan",
      value: function (t, e) {
    ...
    return T(i, [{
      ...
      key: "inputChannels",
      value: function (t) {
        1 === t ? (this.input.disconnect(), this.input.connect(this.left), this.input.connect(this.right)) : 2 === t && (void 0 === this.splitter && (this.splitter = x.createChannelSplitter(2)), this.input.disconnect(), this.input.connect(this.splitter), this.splitter.connect(this.left, 1), this.splitter.connect(this.right, 0))
      }
    }, {
      key: "connect",
      value: function (t) {
  ...
  function O(t, e, n, i) {
    A(this, O), this.callback = t, this.time = e, this.id = n, this.val = i
  }
  ...
  var R = function () {
    function o(t, e, n, i) {
      if (A(this, o), void 0 !== t) {
        if ("string" == typeof t || "string" == typeof t[0]) {
          ...
          this.url = r
        } else if ("object" === k(t) && !(window.File && window.FileReader && window.FileList && window.Blob)) throw "Unable to load file because the File API is not supported";
    ...
    return function (t, e, n) {
      ...
      value: function (n, i) {
        ...
        if (void 0 !== this.url && "" !== this.url) {
          ...
          s.addEventListener("progress", function (t) {
            ...
            if (200 === s.status) {
              if (!r.panner) return;
              C.decodeAudioData(s.response, function (t) {
          ...
          t.onload = function () {
            r.panner && C.decodeAudioData(t.result, function (t) {
              r.panner && (r.buffer = t, r.panner.inputChannels(t.numberOfChannels), n && n(r))
            })
      ...
      key: "currentTime",
      value: function () {
        return this.reversed ? Math.abs(this._lastPos - this.buffer.length) / C.sampleRate : this._lastPos / C.sampleRate
      }
    }, {
      key: "jump",
      value: function (t, e) {
      ...
      value: function () {
        var e = this,
          ...
          r = y(256);
        return n._workletNode && (n._workletNode.disconnect(), delete n._workletNode), n._workletNode = new AudioWorkletNode(C, s.a.soundFileProcessor, {
          processorOptions: {
            bufferSize: r
          }
          ...
          for (var e = t.length, n = C.createBuffer(1, t.length, C.sampleRate), i = n.getChannelData(0), r = 0; r < e; r++) i[r] = r;
          return n
  ...
  p5.Envelope = function (t, e, n, i, r, o) {
    this.aTime = t || .1, this.aLevel = e || 1, this.dTime = n || .5, this.dLevel = i || 0, this.rTime = r || 0, this.rLevel = o || 0, this._rampHighPercentage = .98, this._rampLowPercentage = .02, this.output = p.audiocontext.createGain(), this.control = new it.a, this._init(), this.control.connect(this.output), this.connection = null, this.mathOps = [this.control], this.isExponential = !1, this.sourceToClear = null, this.wasTriggered = !1, p.soundArray.push(this)
  ...
  var lt = function () {
    ...
    ft = function () {
      function i(t) {
        ...
        return function (t, e) {
          if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
        }(this, i), delete(e = at(this, ut(i).call(this))).f, delete e.freq, delete e.oscillator, n = "brown" === t ? pt : "pink" === t ? ht : lt, e.buffer = n, e
      }
      return function (t, e) {
          if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
          t.prototype = Object.create(e && e.prototype, {
  ...
  var wt = function () {
    function r(t, e) {
      ...
      ! function (t, e) {
        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
      }(this, r), (n = _t(this, gt(r).call(this, t, "sawtooth"))).w = e || 0, n.osc2 = new K(t), n.dNode = p.audiocontext.createDelay(), n.dcOffset = Tt(), n.dcGain = p.audiocontext.createGain(), n.dcOffset.connect(n.dcGain), n.dcGain.connect(n.output), n.f = t || 440;
  ...
  var Ot = function () {
    function t() {
      ! function (t, e) {
        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
      }(this, t), this.ac = p.audiocontext, this.input = this.ac.createGain(), this.output = this.ac.createGain(), this._drywet = new Pt.a(1), this.wet = this.ac.createGain(), this.input.connect(this._drywet.a), this.wet.connect(this._drywet.b), this._drywet.connect(this.output), this.connect(), p.soundArray.push(this)
    }
    return function (t, e, n) {
      ...
      key: "drywet",
      value: function () {
        return "undefined" != typeof fade && (this._drywet.fade.value = fade), this._drywet.fade.value
      }
    }, {
      key: "connect",
      value: function (t) {
  ...
  var Mt = function () {
      function n(t) {
        var e;
        return Rt(this, n), (e = Et(this, Bt(n).call(this))).biquad = e.ac.createBiquadFilter(), e.input.connect(e.biquad), e.biquad.connect(e.wet), t && e.setType(t), e._on = !0, e._untoggledType = e.biquad.type, e
      }
      return Vt(n, Ot),
        function (t, e, n) {
          ...
          key: "dispose",
          value: function () {
            Nt(Bt(n.prototype), "dispose", this).call(this), this.biquad && (this.biquad.disconnect(), delete this.biquad)
          }
        }]), n
    }(),
    Ft = function () {
      function t() {
        return Rt(this, t), Et(this, Bt(t).call(this, "lowpass"))
      }
      return Vt(t, Mt), t
    }(),
    Dt = function () {
      function t() {
        return Rt(this, t), Et(this, Bt(t).call(this, "highpass"))
      }
      return Vt(t, Mt), t
    }(),
    It = function () {
      function t() {
        return Rt(this, t), Et(this, Bt(t).call(this, "bandpass"))
      }
      return Vt(t, Mt), t
    }(),
    Ut = Mt;
  ...
  var Xt = function () {
    function i(t, e) {
      ...
      return function (t, e) {
        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
      }(this, i), (n = zt(this, Wt(i).call(this, "peaking"))).disconnect(), n.set(t, e), n.biquad.gain.value = 0, delete n.input, delete n.output, delete n._drywet, delete n.wet, n
    }
    return function (t, e) {
        if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
        t.prototype = Object.create(e && e.prototype, {
  ...
  var te = function () {
    function s(t) {
      ...
      ! function (t, e) {
        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
      }(this, s), e = $t(this, Jt(s).call(this)), n = 3 === (t = 3 === t || 8 === t ? t : 3) ? Math.pow(2, 3) : 2, e.bands = [];
    ...
    return function (t, e) {
      ...
      function (t, e, n) {
        ...
        key: "dispose",
        value: function () {
          if (Qt(Jt(s.prototype), "dispose", this).call(this), this.bands) {
  ...
  var ce = function () {
    function e() {
      ...
      return function (t, e) {
        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
      }(this, e), (t = oe(this, ae(e).call(this))).panner = t.ac.createPanner(), t.panner.panningModel = "HRTF", t.panner.distanceModel = "linear", t.panner.connect(t.output), t.input.connect(t.panner), t
    }
    return function (t, e) {
        if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
        t.prototype = Object.create(e && e.prototype, {
      ...
      function (t, e, n) {
        ...
        key: "dispose",
        value: function () {
          se(ae(e.prototype), "dispose", this).call(this), this.panner && (this.panner.disconnect(), delete this.panner)
        }
      }]), e
  }();
  ...
  var me = function () {
    function e() {
      ...
      return function (t, e) {
        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
      }(this, e), (t = pe(this, de(e).call(this)))._split = t.ac.createChannelSplitter(2), t._merge = t.ac.createChannelMerger(2), t._leftGain = t.ac.createGain(), t._rightGain = t.ac.createGain(), t.leftDelay = t.ac.createDelay(), t.rightDelay = t.ac.createDelay(), t._leftFilter = new Ut, t._rightFilter = new Ut, t._leftFilter.disconnect(), t._rightFilter.disconnect(), t._leftFilter.biquad.frequency.setValueAtTime(1200, t.ac.currentTime), t._rightFilter.biquad.frequency.setValueAtTime(1200, t.ac.currentTime), t._leftFilter.biquad.Q.setValueAtTime(.3, t.ac.currentTime), t._rightFilter.biquad.Q.setValueAtTime(.3, t.ac.currentTime), t.input.connect(t._split), t.leftDelay.connect(t._leftGain), t.rightDelay.connect(t._rightGain), t._leftGain.connect(t._leftFilter.input), t._rightGain.connect(t._rightFilter.input), t._merge.connect(t.wet), t._leftFilter.biquad.gain.setValueAtTime(1, t.ac.currentTime), t._rightFilter.biquad.gain.setValueAtTime(1, t.ac.currentTime), t.setType(0), t._maxDelay = t.leftDelay.delayTime.maxValue, t.feedback(.5), t
    }
    return function (t, e) {
        if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
        t.prototype = Object.create(e && e.prototype, {
      ...
      function (t, e, n) {
        ...
        key: "dispose",
        value: function () {
          fe(de(e.prototype), "dispose", this).call(this), this._split.disconnect(), this._leftFilter.dispose(), this._rightFilter.dispose(), this._merge.disconnect(), this._leftGain.disconnect(), this._rightGain.disconnect(), this.leftDelay.disconnect(), this.rightDelay.disconnect(), this._split = void 0, this._leftFilter = void 0, this._rightFilter = void 0, this._merge = void 0, this._leftGain = void 0, this._rightGain = void 0, this.leftDelay = void 0, this.rightDelay = void 0
        }
      }]), e
  }();
  ...
  var Pe = function () {
      function e() {
        var t;
        return _e(this, e), (t = Te(this, xe(e).call(this)))._initConvolverNode(), t.input.gain.value = .5, t._seconds = 3, t._decay = 2, t._reverse = !1, t._buildImpulse(), t
      }
      return Se(e, Ot), be(e, [{
        ...
        key: "dispose",
        value: function () {
          we(xe(e.prototype), "dispose", this).call(this), this._teardownConvolverNode()
        }
      }]), e
    }(),
    Ae = function () {
      function r(t, e, n) {
        var i;
        return _e(this, r), (i = Te(this, xe(r).call(this)))._initConvolverNode(), i.input.gain.value = .5, t ? (i.impulses = [], i._loadBuffer(t, e, n)) : (i._seconds = 3, i._decay = 2, i._reverse = !1, i._buildImpulse()), i.impulses = [], i.set = null, i
      }
      return Se(r, Pe), be(r, [{
        key: "_loadBuffer",
        ...
        key: "dispose",
        value: function () {
          for (var t in we(xe(r.prototype), "dispose", this).call(this), this.impulses) this.impulses[t] && (this.impulses[t] = null)
        }
      }]), r
    }();
  var Oe = n(11),
  ...
  function Ne(t, e, n) {
    return e && Ee(t.prototype, e), n && Ee(t, n), t
  }
  ...
  function je(t, e, n) {
    Be(this, je), this.phraseStep = 0, this.name = t, this.callback = e, this.sequence = n
  }
  var Me = function () {
      function n(t, e) {
        Be(this, n), this.length = t || 0, this.partStep = 0, this.phrases = [], this.isPlaying = !1, this.noLoop(), this.tatums = e || .0625, this.metro = new qe, this.metro._init(), this.metro.beatLength(this.tatums), this.metro.setBPM(Ve), p.parts.push(this), this.callback = function () {}
      }
      return Ne(n, [{
        key: "setBPM",
        value: function (t, e) {
        ...
        value: function (t, e, n) {
          var i;
          if (3 === arguments.length) i = new je(t, e, n);
          else {
            if (!(t instanceof je)) throw "invalid input. addPhrase accepts name, callback, array or a p5.Phrase";
            i = t
          }
  ...
  var Ye = function () {
    function e() {
      ...
      return function (t, e) {
        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
      }(this, e), (t = ze(this, Ze(e).call(this))).compressor = t.ac.createDynamicsCompressor(), t.input.connect(t.compressor), t.compressor.connect(t.wet), t
    }
    return function (t, e) {
        if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
        t.prototype = Object.create(e && e.prototype, {
      ...
      function (t, e, n) {
        ...
        key: "dispose",
        value: function () {
          We(Ze(e.prototype), "dispose", this).call(this), this.compressor && (this.compressor.disconnect(), delete this.compressor)
        }
      }]), e
  }();
  ...
  var Je = p.audiocontext,
    Ke = function () {
      function e() {
        ! function (t, e) {
          if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
        }(this, e), this.input = Je.createGain(), this.output = Je.createGain(), this._inputChannels = 2, this._outputChannels = 2;
        var t = y(1024);
        this._workletNode = new AudioWorkletNode(Je, s.a.recorderProcessor, {
      ...
      return function (t, e, n) {
        ...
        key: "setInput",
        value: function (t) {
          this.input.disconnect(), this.input = null, this.input = Je.createGain(), this.input.connect(this._workletNode), this.input.connect(this.output), t ? t.connect(this.input) : p5.soundOut.output.connect(this.input)
        }
      }, {
        key: "record",
  ...
  var un = function () {
    function r(t, e) {
      ...
      if (function (t, e) {
          if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
        }(this, r), n = nn(this, on(r).call(this)), void 0 === t && (t = .25), "number" != typeof t) throw new Error("amount must be a number");
      if (void 0 === e && (e = "2x"), "string" != typeof e) throw new Error("oversample must be a String");
      var i = p5.prototype.map(t, 0, 1, 0, 2e3);
      return n.waveShaperNode = n.ac.createWaveShaper(), n.amount = i, n.waveShaperNode.curve = an(i), n.waveShaperNode.oversample = e, n.input.connect(n.waveShaperNode), n.waveShaperNode.connect(n.wet), n
    }
    return function (t, e) {
        if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
        t.prototype = Object.create(e && e.prototype, {
      ...
      function (t, e, n) {
        ...
        value: function (t, e) {
          if (t) {
            ...
            this.amount = n, this.waveShaperNode.curve = an(n)
          }
        ...
        key: "dispose",
        value: function () {
          rn(on(r.prototype), "dispose", this).call(this), this.waveShaperNode && (this.waveShaperNode.disconnect(), this.waveShaperNode = null)
        }
      }]), r
  }();
  ...
  var gn = function () {
    function e() {
      ...
      return function (t, e) {
        ...
        return !e || "object" !== fn(e) && "function" != typeof e ? yn(t) : e
      }(this, vn(e).call(this))).oscillator = new et, t.env = new rt, t.env.setRange(1, 0), t.env.setExp(!0), t.setADSR(.02, .25, .05, .35), t.oscillator.disconnect(), t.oscillator.connect(t.output), t.env.disconnect(), t.env.setInput(t.output.gain), t.oscillator.output.gain.value = 1, t.oscillator.start(), t.connect(), p.soundArray.push(yn(t)), Object.defineProperties(yn(t), {
        attack: {
          get: function () {
    ...
    return function (t, e) {
      ...
      function (t, e, n) {
        ...
        key: "dispose",
        value: function () {
          mn(vn(e.prototype), "dispose", this).call(this), this.env && this.env.dispose(), this.oscillator && this.oscillator.dispose()
        }
      }]), e
  }();
  ...
  var xn = function () {
    function n(t, e) {
      ! function (t, e) {
        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
      }(this, n), this.audiovoices = [], this.notes = {}, this._newest = 0, this._oldest = 0, this.maxVoices = e || 8, this.AudioVoice = void 0 === t ? p5.MonoSynth : t, this._voicesInUse = new it.a(0), this.output = p.audiocontext.createGain(), this.connect(), this._allocateVoices(), p.soundArray.push(this)
    }
    return function (t, e, n) {
      e && wn(t.prototype, e), n && wn(t, n)
    }(n, [{
      key: "_allocateVoices",
      value: function () {
      ...
      value: function (t, e, n) {
        var i, r = 2 < arguments.length && void 0 !== n ? n : 0,
          ...
          s = h(t),
          a = e || .1;
        this.notes[s] && null !== this.notes[s].getValueAtTime(o) && this.noteRelease(s, 0), this._voicesInUse.getValueAtTime(o) < this.maxVoices ? i = Math.max(~~this._voicesInUse.getValueAtTime(o), 0) : (i = this._oldest, oldestNote = l(this.audiovoices[this._oldest].oscillator.freq().value), this.noteRelease(oldestNote), this._oldest = (this._oldest + 1) % (this.maxVoices - 1)), this.notes[s] = new it.a, this.notes[s].setValueAtTime(i, o);
  ...
  p5.prototype.getAudioContext = c.b, p5.prototype.userStartAudio = c.c, p5.prototype.sampleRate = function () {
  ...
  }, p5.prototype.registerMethod("remove", p5.prototype.disposeSound), p5.Panner = S, p5.SoundFile = q, p5.prototype.loadSound = function (t, e, n, i) {
  ...
  }, p5.prototype.registerPreloadMethod("loadSound", p5.prototype), p5.Amplitude = N, p5.FFT = V, p5.Oscillator = et, p5.SinOsc = Q, p5.TriOsc = J, p5.SawOsc = K, p5.SqrOsc = tt, p5.Noise = ft, p5.Pulse = wt, p5.AudioIn = St, p5.Effect = Ot, p5.Filter = Ut, p5.LowPass = Ft, p5.HighPass = Dt, p5.BandPass = It, p5.EQ = te, p5.listener3D = ne, p5.Panner3D = ce, p5.Delay = me, p5.Reverb = Pe, p5.Convolver = Ae, p5.prototype.createConvolver = function (t, e, n) {
    ...
    return r.impulses = [], r
  }, p5.prototype.registerPreloadMethod("createConvolver", p5.prototype), p5.Metro = qe, p5.Phrase = je, p5.Part = Me, p5.Score = Fe, p5.SoundLoop = Ue, p5.Compressor = Ye, p5.peakDetect = $e, p5.SoundRecorder = Ke, p5.Distortion = un, p5.Gain = ln, p5.AudioVoice = pn, p5.MonoSynth = gn, p5.OnsetDetect = Tn, p5.PolySynth = xn, p5.Signal = Sn
}]);
